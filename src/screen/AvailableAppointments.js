    ...
    return (
        <View style={[{ backgroundColor: "white", top: 25, height: "100%" }]}>
            ...
            <View style={{ flexDirection: 'row', width: '90%', alignSelf: "center", marginRight: 10, }}>
                <TouchableOpacity style={[styles.btnfilter, isFilter && styles.pressed]} onPress={() => { setIsFilter(true); }}>
                    <Text style={[{ fontSize: 20, color: 'black', textAlign: 'center', }, isFilter && styles.pressedText]}>Filtered</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.btnfilter, { left: 10 }, !isFilter && styles.pressed]} onPress={() => { setIsFilter(false); }}>
                    <Text style={[{ fontSize: 20, color: 'black', textAlign: 'center',}, !isFilter && styles.pressedText]}>All</Text>
                </TouchableOpacity>
            </View>
        ...
        renderItem={({ item }) =>
          <View style={styles.box}>
            <MaterialIcons style={{ alignSelf: "center", marginLeft: 10 }} name="person-pin" size={55} color="#4FA4E5" />
            <View style={[{ left: 30, flexDirection: "column", bottom: 10 }]}>
              <View style={[{ flexDirection: 'row', top: 10, }]}>
                <Text style={styles.provider}>{item.provider}</Text>
                <TouchableOpacity onPress={onPressReview}>
                  <Fontisto style={{ marginLeft: 70, top: 5 }} name="preview" size={28} color="#4FA4E5" />
                </TouchableOpacity>
              </View>
